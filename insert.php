...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="design.php">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="design.php">作品管理</a><span class="crumb-step">&gt;</span><span>新增作品</span></div>
        </div>
        <div class="result-wrap">
            <div class="result-content">
                <form action="insertcheck.php" method="post" id="myform" name="myform" enctype="multipart/form-data">
